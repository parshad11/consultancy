...
<body>
    <form action="" id="adminmessage">
        @csrf
        <div class="message-box">
            <div class="message">
                <input type="text" name="adminmessage" id="adminmessage" placeholder="Enter your message">
...
$(document).ready(function(){
    ...
    $("button").click(function(s){
        ...
        url: "insert-admin-message",
	    method:"POST",
        data:$("#adminmessage").serialize(),
